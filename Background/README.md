...
```
./bin/fTest_dijet --workspace /afs/cern.ch/work/e/elfontan/private/dijetAnalysis_ScoutingRun3/BKGModelling/FittingDijetMass/ws/dijetWS_VBF_fullEnvelope_5percSR_DataModel.root --ncats 1 --singleCat 1 --rebinFactor 1  --outDir /eos/user/e/elfontan/www//dijetAnaRun3/BKGModelling/VBF --saveMultiPdf multipdf_vbf.root --mass-var CMS_dijet_mass --ws-name dijet_ws --data-name data_obs --cat-name VBF --mass-min 300 --mass-max 1000 --includeTurnOn 1

./bin/fTest_dijet --workspace /afs/cern.ch/work/e/elfontan/private/dijetAnalysis_ScoutingRun3/BKGModelling/FittingDijetMass/ws/dijetWS_BOOmsd_fullEnvelope_5percSR_DataModel.root --ncats 1 --singleCat 1 --includeTurnOn 1 --rebinFactor 1  --outDir /eos/user/e/elfontan/www//dijetAnaRun3/BKGModelling/TEST  --saveMultiPdf multipdf_Boo.root --mass-var CMS_dijet_mass --ws-name dijet_ws --data-name data_obs --cat-name BOO

./bin/fTest_dijet --workspace /afs/cern.ch/work/e/elfontan/private/dijetAnalysis_ScoutingRun3/BKGModelling/FittingDijetMass/ws/dijetWS_RES_fullEnvelope_5percSR_DataModel.root --ncats 1 --singleCat 1 --rebinFactor 1  --outDir /eos/user/e/elfontan/www//dijetAnaRun3/BKGModelling/RES --saveMultiPdf multipdf_res.root --mass-var CMS_dijet_mass --ws-name dijet_ws --data-name data_obs --cat-name RES  --includeTurnOn 1 --mass-min 400 --mass-max 800

./bin/fTest_dijet --workspace /afs/cern.ch/work/e/elfontan/private/dijetAnalysis_ScoutingRun3/BKGModelling/FittingDijetMass/ws/dijetWS_PP_fullEnvelope_5percSR_DataModel.root --ncats 1 --singleCat 1 --rebinFactor 1  --outDir /eos/user/e/elfontan/www//dijetAnaRun3/BKGModelling/PP --saveMultiPdf multipdf_pp.root --mass-var CMS_dijet_mass --ws-name dijet_ws --data-name data_obs --cat-name PP --mass-min 400 --mass-max 1000 --includeTurnOn 1
```
