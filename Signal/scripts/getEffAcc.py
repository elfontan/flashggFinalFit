...
def get_options():
  ...
  parser.add_option('--massPoints', dest='massPoints', default='10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65, 70', help='MH')
  #parser.add_option('--massPoints', dest='massPoints', default='5, 10, 15, 20, 25, 30, 35, 40, 45, 50, 55, 60, 65', help='MH')
